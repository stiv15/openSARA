...
$this->idioma ["webServiceNoTipo"] = "<h2>El Web Services fuera de servicio</h2><p>Esto se considera un error fatal.</p><p>Por favor contacte al administrador del sistema. Posiblemente sea necesario registrar correctamente el Web Services.</p>";
